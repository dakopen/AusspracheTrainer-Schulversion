...
class Command(BaseCommand):
    ...
    standard_todos = [
        ...
        {'id': 4, 'title': 'Anfangstest', 'description': 'Bitte starte den ersten Aussprachetest, der am Ende des Trainings verglichen wird. Der Test wird nicht benotet und dein:e Lehrer:in kann dein Ergebnis nicht einsehen.', 'priority': 40, 'action_relative_link': '/first-test/'},
